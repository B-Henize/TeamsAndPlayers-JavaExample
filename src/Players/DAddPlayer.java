...
import java.math.BigDecimal;	// For BigDecimal/Salary
...
public class DAddPlayer extends JDialog implements ActionListener,
											       WindowListener
{
	// ----------------------------------------------------------------------
	// ----------------------------------------------------------------------
	...
	public void AddControls( )
	{
		...
		try
		{
			...
			// Text Boxes
				...
				// m_txtState
				// m_txtState = CUtilities.AddTextBox( this, 170, 160, 25, 185, 50);
	...
	public void windowOpened( WindowEvent weSource )
	{
		try
		{
			...
			// Load the Players list to the combo box
			...
			{
				// No, warn the user ...
				CMessageBox.Show( this,  "Unable to load states information.\n" +
										 "The form will close.\n",
										 getTitle( ) + " Error",
										 enuIconType.Error );
	...
	private boolean SaveData( )
	{
		...
		try
		{
			...
			blnResult = CDatabaseUtilities.AddPlayerToDatabase2( udtNewPlayer );
	...
	// Abstract: Closes the add form without adding anything
	// ----------------------------------------------------------------------
