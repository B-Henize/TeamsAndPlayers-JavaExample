...
public class CUtilities
{
	...
	// Abstract:  Use regular expressions to verify that the phone number is
	// 			  in a valid format. 
	// ----------------------------------------------------------------------
	public static Boolean IsValidPhoneNumber (String strPhoneNumber )
	{
		...
		{
			String strStart = "^";
			String strOptionalSpaceDashOrDot = "[ \\-\\.]?";
			String strStop = "$";
			String strPattern1 = "";
			String strPattern2 = "";
			String strPattern3 = "";
			...
			strPattern1 = strStart
						+ "\\d{3}" + strOptionalSpaceDashOrDot + "\\d{4}"
						+ strStop;
			
			// ###-###-####
			strPattern2 = strStart
						+ "\\d{3}" + strOptionalSpaceDashOrDot + "\\d{3}" + strOptionalSpaceDashOrDot + "\\d{4}"
						+ strStop;
			...
			if( strPhoneNumber.matches( strPattern1 ) == true ||
				...
				strPhoneNumber.matches( strPattern3 ) == true )
			{
				// Yes
	...
	// ----------------------------------------------------------------------
	// Name: IsValidZipCode
	// Abstract:  Use regular expressions to verify that the Zip Code is
	// 			  in a valid format. 
	// ----------------------------------------------------------------------
	public static Boolean IsValidZipCode ( String strZipCode )
	{
		...
		try
		{
			...
			// Does it match any of the formats?
			if( strZipCode.matches( strPattern1 ) == true ||
				strZipCode.matches( strPattern2 ) == true )
			{
				// Yes
	...
	// ----------------------------------------------------------------------
	// Name: IsValidSSN
	// Abstract:  Use regular expressions to verify that the SSN is
	// 			  in a valid format. 
	// ----------------------------------------------------------------------
	public static Boolean IsValidSSN (String strSSN )
	{
		boolean blnIsValidSSN = false;
		...
		try
		{
			...
			// ###-##-####
			strPattern = strStart
					   + "\\d{3}" + strDash + "\\d{2}" + strDash + "\\d{4}" 
					   + strStop;
			
			// Does it match any of the formats?
			if( strSSN.matches( strPattern ) == true )
			{
				// Yes
				blnIsValidSSN = true;
			}
	...
	// Abstract:  Use regular expressions to verify that the Email Address is
	// 			  in a valid format. 
	// ----------------------------------------------------------------------
	...
	public static Boolean IsCurrency( String strBuffer )
	{
		...
		try
		{
			char chrStart = '^';
			char chrStop = '$';
			// \ is the escape character in regular expressions and in Java so it must be doubled up.
			// ( ) denotes a set
			String strOptionalPlusOrMinus = "[\\+\\-]?";
	...
	//			bid decimal which is what we use for currency fields in
	//			the database.
	// ----------------------------------------------------------------------
	...
	// ----------------------------------------------------------------------
	// Name: IsValidDate
	// Abstract:  Use regular expressions to verify that the date is
	// 			  in a valid format. 
	// ----------------------------------------------------------------------
	public static Boolean IsValidDate ( String strDate )
	{
		...
		{
			String strStart = "^";
			String strOptionalDashOrSlash = "[\\-/]?";
			String strStop = "$";
			String strPattern = "";
			
			// ####/##/## -- Four digits, slash or dash, two digits, slash or dash, two digits.
			strPattern = strStart
					   	+ "\\d{4}"
					   	+ strOptionalDashOrSlash
					   	+ "\\d{2}"
					   	+ strOptionalDashOrSlash
					   	+ "\\d{2}"
					   	+ strStop;
			...
			// Does it match any of the formats?
			if( strDate.matches( strPattern ) == true )
			{
				// Yes
				blnIsValidDate = true;
			}
